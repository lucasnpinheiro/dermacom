...
$this->Html->addButton($this->Form->postLink('<i class="fa fa-trash-o"></i> ' . __('Delete'), ['action' => 'delete', $pacientesServico->id], ['confirm' => __('Are you sure you want to delete # {0}?', $pacientesServico->id), 'escape' => false, 'class' => 'btn btn-danger']));
?>
<div class="panel">
    ...
    <div class="panel-body">
        ...
        echo $this->Form->input('servico_id', ['div' => ['class' => 'col-xs-12 col-md-12']]);
        ?>
    </div>
