<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $tabelasValoresHistorico->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $tabelasValoresHistorico->id)]
            )
        ?></li>
...
<div class="tabelasValoresHistoricos form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Tabelas Valores Historico') ?></legend>
        <?php
