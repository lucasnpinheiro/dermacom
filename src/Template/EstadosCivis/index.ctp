                            ...
                            <?php foreach ($estadosCivis as $estadosCivi): ?>
                                <tr>
                                    ...
                                    <td class="actions text-right">
                                        <?= $this->Html->link(null, ['action' => 'edit', $estadosCivi->id], ['title' => __('Edit'), 'class' => 'btn btn-primary btn-sm btn-rounded fa fa-pencil']) ?>
                                        <?= $this->Form->postLink(null, ['action' => 'delete', $estadosCivi->id], ['title' => __('Delete'), 'class' => 'btn btn-danger btn-sm btn-rounded fa fa-eraser', 'confirm' => __('Are you sure you want to delete # {0}?', $estadosCivi->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
