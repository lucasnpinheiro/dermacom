...
$this->Html->addButton($this->Form->postLink('<i class="fa fa-trash-o"></i> ' . __('Delete'), ['action' => 'delete', $corporaisLeso->id], ['confirm' => __('Are you sure you want to delete # {0}?', $corporaisLeso->id), 'escape' => false, 'class' => 'btn btn-danger']));
?>
<div class="panel">
