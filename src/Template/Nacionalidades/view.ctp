<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Nacionalidade'), ['action' => 'edit', $nacionalidade->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Nacionalidade'), ['action' => 'delete', $nacionalidade->id], ['confirm' => __('Are you sure you want to delete # {0}?', $nacionalidade->id)]) ?> </li>
...
<div class="nacionalidades view large-9 medium-8 columns content">
    <h3><?= h($nacionalidade->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($nacionalidade->pacientes)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($nacionalidade->pacientes as $pacientes): ?>
            <tr>
