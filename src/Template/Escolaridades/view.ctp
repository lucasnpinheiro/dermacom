<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Escolaridade'), ['action' => 'edit', $escolaridade->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Escolaridade'), ['action' => 'delete', $escolaridade->id], ['confirm' => __('Are you sure you want to delete # {0}?', $escolaridade->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Escolaridades'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Escolaridade'), ['action' => 'add']) ?> </li>
        <li><?= $this->Html->link(__('List Pacientes'), ['controller' => 'Pacientes', 'action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Paciente'), ['controller' => 'Pacientes', 'action' => 'add']) ?> </li>
    </ul>
</nav>
<div class="escolaridades view large-9 medium-8 columns content">
    <h3><?= h($escolaridade->id) ?></h3>
    <table class="vertical-table">
        <tr>
            <th><?= __('Nome') ?></th>
            <td><?= h($escolaridade->nome) ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
    ...
    <div class="related">
        ...
        <?php if (!empty($escolaridade->pacientes)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($escolaridade->pacientes as $pacientes): ?>
            <tr>
