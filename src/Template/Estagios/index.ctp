                            ...
                            <?php foreach ($estagios as $estagio): ?>
                                <tr>
                                    ...
                                    <td class="actions text-right">
                                        <?= $this->Html->link(null, ['action' => 'edit', $estagio->id], ['title' => __('Edit'), 'class' => 'btn btn-primary btn-sm btn-rounded fa fa-pencil']) ?>
                                        <?= $this->Form->postLink(null, ['action' => 'delete', $estagio->id], ['title' => __('Delete'), 'class' => 'btn btn-danger btn-sm btn-rounded fa fa-eraser', 'confirm' => __('Are you sure you want to delete # {0}?', $estagio->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
