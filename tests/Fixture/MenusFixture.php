...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'item_menu' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-09-17 00:42:07',
            'modified' => '2016-09-17 00:42:07'
        ],
    ];
}
