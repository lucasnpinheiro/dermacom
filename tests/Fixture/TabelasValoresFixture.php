...
/**
 * TabelasValoresFixture
 *
 */
class TabelasValoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'valor_origem' => ['type' => 'float', 'length' => 11, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'valor_repasse' => ['type' => 'float', 'length' => 11, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'data_fim' => '2016-09-07',
            'reajuste_id' => 1,
            'created' => '2016-09-07 14:00:12',
            'modified' => '2016-09-07 14:00:12'
        ],
    ];
}
