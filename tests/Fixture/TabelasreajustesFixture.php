...
class TabelasreajustesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tabelasvalor_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'tipo_calculo' => 1,
            'valor' => 1,
            'created' => '2016-09-03 19:47:30',
            'modified' => '2016-09-03 19:47:30'
        ],
    ];
}
