...
class TabelasvaloresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tabelaspreco_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'data_fim' => '2016-09-03',
            'reajuste_id' => 1,
            'created' => '2016-09-03 19:47:38',
            'modified' => '2016-09-03 19:47:38'
        ],
    ];
}
